...
![Handmade hamburger bag]({{ "/images/bag.jpg" | relative_url }}){: .align-left width="240" }

![(3D_Beaded_Rabbit_Girl)]({{ "/images/rabbit_girl.jpg" | relative_url }}){: .align-left width="240" }

![(Paint)]({{ "/images/succulent.jpg" | relative_url }}){: .align-left width="240" }

![(Birthday Cake)]({{ "/images/birthday_cake.jpg" | relative_url }}){: .align-left width="240" }
